...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  :root {
    ...
    --shadow-lg: 0 10px 15px -3px rgba(17, 191, 98, 0.1), 0 4px 6px -2px rgba(112, 227, 17, 0.05);
  }
  ...
  .modal-overlay {
    ...
    background: rgba(61, 169, 15, 0.45); z-index: 200;
  ...
  input:focus, select:focus, textarea:focus {
    ...
    box-shadow: 0 0 0 3px rgba(236, 139, 20, 0.12);
  }
  ...
  #toast {
    ...
    background: #1b51a8; color: var(--white);
